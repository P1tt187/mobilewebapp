        ...
        loadDataFromJSONSource: function() {
            ...
            var Loading = {
                loadJSON: function(tmp_arr) {
                    ...
                    // Öffne JSON-Quelle
                    var data = $.parseJSON(json_source);
...
function getTimeSlot(nb) {
    switch (nb) {
        case 0:
            return '08.15-<br>09.45';
        case 1:
            return '10.00-<br>11.30';
        case 2:
            return '11.45-<br>13.15';
        case 3:
            return '14.15-<br>15.45';
        case 4:
            return '16.00-<br>17.30';
        case 5:
            return '17.45-<br>19.15';
        case 6:
            return '19.30-<br>21.00';
    }
}
;
